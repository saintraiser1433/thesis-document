...
export default function UploadThesisPage() {
  ...
  const handleConfirmUpload = async () => {
    ...
    try {
      // Find the school year ID from the name
      ...
      const createdThesis = await response.json()
      console.log("Thesis created successfully:", createdThesis)

      toast.success("Thesis uploaded successfully!")
      
      // Wait a moment for the toast to show, then redirect
      setTimeout(() => {
        router.push("/program-head/thesis")
      }, 1500)
    } catch (error) {
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Upload a new thesis to the archive system.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Optional: Mark if published online and add publication details
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add indexing references where the thesis can be found
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to upload this thesis? This action cannot be undone.
                <br /><br />
